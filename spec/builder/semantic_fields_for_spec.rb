...
describe 'FormtasticBootstrap::FormBuilder#fields_for' do
  ...
  context 'within a form_for block' do
    ...
    it 'should sanitize html id for li tag' do
      ...
      output_buffer.should have_tag('form #post_author_1_login_input')
    ...
    it 'should use namespace provided in nested fields' do
      ...
      output_buffer.should have_tag('form #context2_post_author_1_login_input')
    end
  end
  ...
  context "when I rendered my own hidden id input" do
    ...
    it "should render the hidden input inside an fieldset.hidden" do
      output_buffer.should have_tag 'fieldset.hidden div.controls input#author_posts_attributes_0_id'
    end
  end
