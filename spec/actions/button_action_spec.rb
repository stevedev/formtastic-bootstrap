...
describe 'ButtonAction', 'when submitting' do
  ...
  it 'should render a submit type of button' do
    output_buffer.should have_tag('button[@type="submit"].btn.action.button_action.primary')
  end
...
describe 'ButtonAction', 'when resetting' do
  ...
  it 'should render a reset type of button' do
    output_buffer.should have_tag('button[@type="reset"].btn.action.button_action', :text => "Reset Post")
  end

  it 'should not render a value attribute' do
    output_buffer.should_not have_tag('button[@value].btn.action.button_action')
  end
