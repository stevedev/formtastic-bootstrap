...
describe 'LinkAction', 'when cancelling' do
  ...
  context 'without a :url' do
    ...
    it 'should render a submit type of input' do
      output_buffer.should have_tag('a[@href="javascript:history.back()"].btn.action.link_action')
    end
  ...
  context 'with a :url as String' do
    ...
    it 'should render a submit type of input' do
      output_buffer.should have_tag('a[@href="http://foo.bah/baz"].btn.action.link_action')
    end
  ...
  context 'with a :url as Hash' do
    ...
    it 'should render a submit type of input' do
      output_buffer.should have_tag('a[@href="/mock/path"].btn.action.link_action')
    end
