...
describe 'Formtastic::FormBuilder#actions' do
  ...
  describe 'without a block' do
    ...
    describe 'with no args (default buttons)' do
      ...
      it 'should render a input/button/link for each default action' do
        output_buffer.should have_tag('form fieldset.form-actions .action.input_action', :count => 1)
      end
    ...
    describe 'with button names as args' do
      ...
      it 'should render a form with a fieldset containing a input/button/link for each button arg' do
