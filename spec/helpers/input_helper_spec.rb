...
describe 'FormtasticBootstrap::FormBuilder#input' do
    ...
    describe ':required option' do
      ...
      describe 'when true' do
        ...
        it 'should set a "required" class' do
          with_config :required_string, " required yo!" do
            ...
            output_buffer.should_not have_tag('form fieldset.control-group.optional')
            output_buffer.should have_tag('form fieldset.control-group.required')
          end
        end
        ...
        it 'should append the "required" string to the label' do
          with_config :required_string, " required yo!" do
            ...
            output_buffer.should have_tag('form fieldset.control-group.required label', /required yo/)
          end
        end
      end
      ...
      describe 'when false' do
        ...
        it 'should set an "optional" class' do
          ...
          output_buffer.should_not have_tag('form fieldset.control-group.required')
          output_buffer.should have_tag('form fieldset.control-group.optional')
        end
        ...
        it 'should append the "optional" string to the label' do
          ...
          output_buffer.should have_tag('form fieldset.control-group.optional label', /#{@string}$/)
        end
    ...
    describe ':as option' do
      ...
      describe 'when not provided' do
        ...
        it 'should default to password for forms without objects if column is password' do
          ...
          output_buffer.should have_tag('form fieldset.control-group.password', :count => 3)
        end
    ...
    describe ':label option' do
      ...
      describe 'when provided' do
        it 'should be passed down to the label tag' do
          ...
          output_buffer.should have_tag("form fieldset.control-group label", /Kustom/)
        end
        ...
        it 'should not generate a label if false' do
          ...
          output_buffer.should_not have_tag("form fieldset.control-group label")
        end
            ...
            describe 'and label_str_method not :humanize' do
              it 'should render a label with localized text and not apply the label_str_method' do
                with_config :label_str_method, :reverse do
                  ...
                  output_buffer.should have_tag('form fieldset.control-group label', /Localized title/)
                end
              end
            end
          end
          ...
          describe 'and object is not given' do
            it 'should default the humanized method name, passing it down to the label tag' do
              ...
              with_config :label_str_method, :humanize do
                ...
                output_buffer.should have_tag("form fieldset.control-group label", /#{'meta_description'.humanize}/)
              end
            end
          end
          ...
          describe 'and object is given with label_str_method set to :capitalize' do
            it 'should capitalize method name, passing it down to the label tag' do
              with_config :label_str_method, :capitalize do
                ...
                output_buffer.should have_tag("form fieldset.control-group label", /#{'meta_description'.capitalize}/)
              end
            end
          end
        end
        ...
        describe 'when localized label is provided' do
          ...
          it 'should render a label with localized label (I18n)' do
            with_config :i18n_lookups_by_default, false do
              ...
              output_buffer.should have_tag('form fieldset.control-group label', Regexp.new('^' + @localized_label_text))
            end
          end
          ...
          it 'should render a hint paragraph containing an optional localized label (I18n) if first is not set' do
            with_config :i18n_lookups_by_default, false do
              ...
              output_buffer.should have_tag('form fieldset.control-group label', Regexp.new('^' + @default_localized_label_text))
            end
          end
        end
      end
    ...
    describe ':hint option' do
      ...
      describe 'when provided' do
        ...
        it 'should be passed down to the paragraph tag' do
          ...
          output_buffer.should have_tag("form fieldset.control-group div span.help-inline", hint_text)
        end
        ...
        it 'should have a custom hint class if I ask for one' do
          ...
          output_buffer.should have_tag("form fieldset.control-group div span.custom-hint-class", hint_text)
        end
          ...
          describe 'when provided value (hint value) is set to TRUE' do
            it 'should render a hint paragraph containing a localized hint (I18n)' do
              with_config :i18n_lookups_by_default, false do
                ...
                output_buffer.should have_tag('form fieldset.control-group div span.help-inline', @localized_hint_text)
              end
            end
  ...
  it 'should render a hint paragraph containing a localized hint (I18n) with a custom hint class if i ask for one' do
              with_config :i18n_lookups_by_default, false do
                ...
                output_buffer.should have_tag('form fieldset.control-group div span.custom-hint-class', @localized_hint_text)
              end
            end
            ...
            it 'should render a hint paragraph containing an optional localized hint (I18n) if first is not set' do
              with_config :i18n_lookups_by_default, false do
                ...
                output_buffer.should have_tag('form fieldset.control-group div span.help-inline', @default_localized_hint_text)
              end
            end
          end
          ...
          describe 'when provided value (label value) is set to FALSE' do
            it 'should not render a hint paragraph' do
              with_config :i18n_lookups_by_default, false do
                ...
                output_buffer.should_not have_tag('form fieldset.control-group div span.help-inline', @localized_hint_text)
              end
            end
          end
        end
        ...
        describe 'when localized hint (I18n) is not provided' do
          it 'should not render a hint paragraph' do
            with_config :i18n_lookups_by_default, false do
              ...
              output_buffer.should_not have_tag('form fieldset.control-group div span.help-inline')
            end
          end
        end
      end
    ...
    describe ':wrapper_html option' do
      ...
      describe 'when provided' do
        it 'should be passed down to the li tag' do
          ...
          output_buffer.should have_tag("form fieldset#another_id")
        end
        ...
        it 'should append given classes to li default classes' do
          ...
          output_buffer.should have_tag("form fieldset.control-group.string")
          output_buffer.should have_tag("form fieldset.control-group.required")
          output_buffer.should have_tag("form fieldset.control-group.another_class")
        end
        ...
        it 'should allow classes to be an array' do
          ...
          output_buffer.should have_tag("form fieldset.control-group.string")
          output_buffer.should have_tag("form fieldset.control-group.my_class")
          output_buffer.should have_tag("form fieldset.control-group.another_class")
        end
      end
  ...
  describe 'options re-use' do
    ...
    it 'should retain :as option when re-using the same options hash' do
      ...
      output_buffer.should have_tag 'fieldset.control-group.string', :count => 2
    end
