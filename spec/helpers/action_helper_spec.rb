  ...
  describe 'arguments and options' do
    ...
    describe ':as option' do
      ...
      describe 'when not provided' do
        ...
        it 'should default to an input for submit' do
        ...
        it 'should default to an inpit for reset' do
          concat(semantic_form_for(:project, :url => 'http://test.host') do |builder|
    ...
    describe ':wrapper_html option' do
      ...
      describe 'when provided' do
        it 'should be passed down to the input/button/link tag' do
          concat(semantic_form_for(@new_post) do |builder|
            concat(builder.action(:submit, :wrapper_html => {:id => :another_id}))
          end)
          output_buffer.should have_tag("form #another_id")
        end

        it 'should append given classes to input/button/link default classes' do
          concat(semantic_form_for(@new_post) do |builder|
            concat(builder.action(:submit, :wrapper_html => {:class => :another_class}))
          end)
          output_buffer.should have_tag("form .action")
          output_buffer.should have_tag("form .input_action")
          output_buffer.should have_tag("form .another_class")
        end
        ...
        it 'should allow classes to be an array' do
          ...
          output_buffer.should have_tag("form .action")
          output_buffer.should have_tag("form .input_action")
          output_buffer.should have_tag("form .my_class")
          output_buffer.should have_tag("form .another_class")
        end
      end
      ...
      describe 'when not provided' do
        it 'should use default id and class' do
          ...
          output_buffer.should have_tag("form #post_submit_action")
          output_buffer.should have_tag("form .action")
          output_buffer.should have_tag("form .input_action")
        end
      end
