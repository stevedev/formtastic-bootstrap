...
describe 'Formtastic::FormBuilder#inputs' do
  ...
  describe 'with a block (block forms syntax)' do
    ...
    describe 'when no options are provided' do
      ...
      # As of 2.0, Bootstrap no longer wraps the whole shebang in a fieldset
      #it 'should render a fieldset inside the form, with a class of "inputs"' do
      #  output_buffer.should have_tag("form fieldset.inputs")
      #end

      it 'should not render a fieldset inside the form' do
        # output_buffer.should have_tag("form fieldset.inputs ol")
        output_buffer.should_not have_tag("form fieldset.control-group")
      end

      it 'should render the contents of the block inside the form' do
        # output_buffer.should have_tag("form fieldset.inputs ol", /hello/)
        output_buffer.should have_tag("form", /hello/)
      end
    ...
    describe 'when a :for option is provided' do
      ...
      it 'should render nested inputs' do
        ...
        output_buffer.should have_tag("form #post_author_attributes_login")
      ...
      it 'should concat rendered nested inputs to the template' do
        ...
        output_buffer.should have_tag("form #post_author_attributes_login")
        output_buffer.should_not have_tag("form #author_login")
      ...
      describe "as a symbol representing a has_many association name" do
        ...
        it 'should nest the inputs with a fieldset, legend and :name input for each item' do
          ...
          output_buffer.should have_tag("form legend", :count => 2)
          output_buffer.should have_tag("form legend", "1", :count => 1)
          output_buffer.should have_tag("form legend", "2")
      ...
      it 'should pass options down to semantic_fields_for' do
        ...
        output_buffer.should have_tag('form fieldset.control-group div.controls #post_author_attributes_10_login')
      end
      ...
      it 'should send parent_builder as an option to allow child index interpolation' do
        ...
        output_buffer.should have_tag('form legend', 'Author #1')
      end
      ...
      it 'should also provide child index interpolation when nested child index is a hash' do
        ...
        output_buffer.should have_tag('form legend', 'Author #11')
      end
    end
    ...
    describe 'when a :name or :title option is provided' do
      describe 'and is a string' do
        ...
        it 'should render a legend inside the form' do
          output_buffer.should have_tag("form legend", /^#{@legend_text}$/)
          output_buffer.should have_tag("form legend", /^#{@legend_text_using_name}$/)
          output_buffer.should have_tag("form legend", /^#{@legend_text_using_title}$/)
          output_buffer.should have_tag("form legend", /^#{@nested_forms_legend_text}$/)
        end
      end
      ...
      describe 'and is a symbol' do
        ...
        it 'should render a localized legend inside the form' do
          output_buffer.should have_tag("form legend", /^#{@localized_legend_text}$/)
          output_buffer.should have_tag("form legend", /^#{@localized_legend_text_using_name}$/)
          output_buffer.should have_tag("form legend", /^#{@localized_legend_text_using_title}$/)
          output_buffer.should have_tag("form legend", /^#{@localized_nested_forms_legend_text}$/)
        end
      end
    end
  ...
  describe 'without a block' do
    ...
    describe 'with no args (quick forms syntax)' do
      ...
      it 'should render a fieldset item in the form for each column and reflection' do
        # Remove the :has_many macro and :created_at column
        count = ::Post.content_columns.size + ::Post.reflections.size - 2
        output_buffer.should have_tag('form > fieldset.control-group', :count => count)
      end

      it 'should render a string list item for title' do
        output_buffer.should have_tag('form > fieldset.control-group.string')
      end

      it 'should render a text list item for body' do
        output_buffer.should have_tag('form > fieldset.control-group.text')
      end

      it 'should render a select list item for author_id' do
        output_buffer.should have_tag('form > fieldset.control-group.select', :count => 1)
      end

      it 'should not render timestamps inputs by default' do
        output_buffer.should_not have_tag('form > fieldset.control-group.datetime')
      end
    ...
    describe 'with column names as args (short hand forms syntax)' do
      describe 'and an object is given' do
        it 'should render a form with two fieldsets' do
          concat(semantic_form_for(@new_post) do |builder|
            concat(builder.inputs(:title, :body))
          end)

          output_buffer.should have_tag('form > fieldset.control-group', :count => 2)
          output_buffer.should have_tag('form > fieldset.control-group.string')
          output_buffer.should have_tag('form > fieldset.control-group.text')
        end
      end
      ...
      describe 'and no object is given' do
        it 'should render a form with two fieldsets' do
          ...
          output_buffer.should have_tag('form > fieldset.control-group.string', :count => 2)
        end
      end
    ...
    describe 'when a :for option is provided' do
      describe 'and an object is given' do
        it 'should render nested inputs' do
          ...
          output_buffer.should have_tag("form #post_author_login")
          output_buffer.should_not have_tag("form #author_login")
        end
      end
      ...
      describe 'and no object is given' do
        it 'should render nested inputs' do
          ...
          output_buffer.should have_tag("form #project_author_login")
          output_buffer.should_not have_tag("form #project_login")
        end
      end
    end
    ...
    describe 'with column names and an options hash as args' do
      ...
      it 'should render a form with four fieldsets' do
        output_buffer.should have_tag('form > fieldset.control-group', :count => 4)
      end

      # Bootstrap 2.0 doesn't use a fieldset to wrap sets of inputs
      #it 'should pass the options down to the fieldset' do
      #  output_buffer.should have_tag('form > fieldset#my-id.inputs')
      #end

      it 'should use the special :name option as a text for the legend tag' do
        output_buffer.should have_tag('form > legend', /^#{@legend_text_using_option}$/)
        output_buffer.should have_tag('form > legend', /^#{@legend_text_using_arg}$/)
      end
    end

  end

  # As of 2.0, Bootstrap no longer wraps the whole shebang in a fieldset, so inputs output nothing without children input
  #describe 'nesting' do
  #
