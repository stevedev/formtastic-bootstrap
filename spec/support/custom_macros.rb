  ...
  module ClassMethods
    ...
    def it_should_have_input_wrapper_with_class(class_name)
      it "should have input wrapper with class '#{class_name}'" do
        output_buffer.should have_tag("form fieldset.#{class_name}")
      end
    end
    ...
    def it_should_have_input_class_in_the_right_place
      it "should have 'controls' class in the right place" do
        output_buffer.should have_tag("form fieldset.control-group div.controls")
        output_buffer.should_not have_tag("form fieldset.control-group.controls")
      end
    end

    def it_should_have_input_wrapper_with_id(id_string)
      it "should have input wrapper with id '#{id_string}'" do
        output_buffer.should have_tag("form fieldset##{id_string}")
      end
    end
    ...
    def it_should_have_a_nested_div
      it "should have a nested div" do
        output_buffer.should have_tag("form fieldset.control-group div")
      end
    end

    def it_should_have_a_nested_div_with_class(klass)
      it "should have a nested div with class #{klass}" do
        output_buffer.should have_tag("form fieldset.control-group div.#{klass}")
      end
    end
    ...
    def it_should_have_a_nested_unordered_list_with_class(klass)
      it "should have a nested unordered list with class #{klass}" do
        output_buffer.should have_tag("form fieldset.control-group div ul.#{klass}")
      end
    end

    def it_should_have_label_with_text(string_or_regex)
      it "should have a label with text '#{string_or_regex}'" do
        output_buffer.should have_tag("form fieldset.control-group label", string_or_regex)
      end
    end
    ...
    def it_should_have_label_for(element_id)
      it "should have a label for ##{element_id}" do
        ...
        output_buffer.should have_tag("form fieldset.control-group label[@for='#{element_id}']")
        output_buffer.should_not have_tag("form fieldset.control-group label.label")
      end
    end
    ...
    def it_should_have_input_with_id(element_id)
      it "should have an input with id '#{element_id}'" do
        # output_buffer.should have_tag("form fieldset.control-group div.controls input##{element_id}")
        output_buffer.should have_tag("form fieldset.control-group div.controls input[@id=\"#{element_id}\"]")
      end
    end

    def it_should_have_select_with_id(element_id)
      it "should have a select box with id '#{element_id}'" do
        output_buffer.should have_tag("form fieldset.control-group div.controls select##{element_id}")
      end
    end

    def it_should_have_input_with_type(input_type)
      it "should have a #{input_type} input" do
        output_buffer.should have_tag("form fieldset.control-group div.controls input[@type=\"#{input_type}\"]")
      end
    end

    def it_should_have_input_with_name(name)
      it "should have an input named #{name}" do
        output_buffer.should have_tag("form fieldset.control-group div.controls input[@name=\"#{name}\"]")
      end
    end

    def it_should_have_textarea_with_name(name)
      it "should have an input named #{name}" do
        output_buffer.should have_tag("form fieldset.control-group div.controls textarea[@name=\"#{name}\"]")
      end
    end

    def it_should_have_textarea_with_id(element_id)
      it "should have an input with id '#{element_id}'" do
        output_buffer.should have_tag("form fieldset.control-group div.controls textarea##{element_id}")
      end
    end
    ...
    def it_should_use_default_text_field_size_when_not_nil(as)
      it 'should use default_text_field_size when not nil' do
        with_config :default_text_field_size, 30 do
          ...
          output_buffer.should have_tag("form fieldset.control-group div.controls input[@size='#{FormtasticBootstrap::FormBuilder.default_text_field_size}']")
        end
      end
    end
    ...
    def it_should_not_use_default_text_field_size_when_nil(as)
      it 'should not use default_text_field_size when nil' do
        with_config :default_text_field_size, nil do
          ...
          output_buffer.should have_tag("form fieldset.control-group div.controls input")
          output_buffer.should_not have_tag("form fieldset.control-group div.controls input[@size]")
        end
      end
    end
    ...
    def it_should_apply_custom_for_to_label_when_input_html_id_provided(as)
      it 'it should apply custom for to label when input_html :id provided' do
        ...
        output_buffer.should have_tag('form fieldset.control-group label[@for="myid"]')
      end
    end
    ...
    def it_should_have_maxlength_matching_column_limit
      it 'should have a maxlength matching column limit' do
        ...
        output_buffer.should have_tag("form fieldset.control-group div.controls input[@maxlength='50']")
      end
    end
    ...
    def it_should_apply_error_logic_for_input_type(type, inline_or_block = :inline)
      describe 'when there are errors on the object for this method' do
        ...
        it 'should apply an errors class to the list item' do
          ...
          output_buffer.should have_tag('form fieldset.error')
        end
        ...
        it 'should not wrap the input with the Rails default error wrapping' do
          ...
          output_buffer.should_not have_tag('fieldset.fieldWithErrors')
        end
        ...
        it 'should render a paragraph for the errors' do
          ...
          # output_buffer.should have_tag('form fieldset.error p.inline-errors')
          if inline_or_block == :inline
            output_buffer.should have_tag('form fieldset.error span.help-inline')
          else
            output_buffer.should have_tag('form fieldset.error span.help-block')
          end
        end
        ...
        it 'should not display an error list' do
          ...
          output_buffer.should have_tag('form fieldset.error ul.errors')
        end
      end
    ...
    def it_should_use_the_collection_when_provided(as, countable)
      describe 'when the :collection option is provided' do
        ...
        it 'should use the provided collection' do
          ...
          output_buffer.should have_tag("form fieldset.#{as} #{countable}", :count => @authors.size + (as == :select ? 1 : 0))
        end
        ...
        describe 'and the :collection is an array of strings' do
          ...
          it "should use the string as the label text and value for each #{countable}" do
            ...
            @categories.each do |value|
              output_buffer.should have_tag("form fieldset.#{as}", /#{value}/)
              output_buffer.should have_tag("form fieldset.#{as} #{countable}[@value='#{value}']")
            end
          end
          ...
          if as == :radio
            it 'should generate a sanitized label for attribute' do
              ...
              output_buffer.should have_tag("form fieldset div label[@for='post_author_category_name_general']")
              output_buffer.should have_tag("form fieldset div label[@for='post_author_category_name_design']")
              output_buffer.should have_tag("form fieldset div label[@for='post_author_category_name_development']")
              output_buffer.should have_tag("form fieldset div label[@for='post_author_category_name_quasi-serious_inventions']")
            end
          end
        end
        ...
        describe 'and the :collection is a hash of strings' do
          ...
          it "should use the key as the label text and the hash value as the value attribute for each #{countable}" do
            ...
            @categories.each do |label, value|
              output_buffer.should have_tag("form fieldset.#{as}", /#{label}/)
              output_buffer.should have_tag("form fieldset.#{as} #{countable}[@value='#{value}']")
            end
          end
        end
        ...
        describe 'and the :collection is an array of arrays' do
          ...
          it "should use the first value as the label text and the last value as the value attribute for #{countable}" do
            ...
            @categories.each do |text, value|
              ...
              output_buffer.should have_tag("form fieldset.#{as} #{label}", /#{text}/i)
              output_buffer.should have_tag("form fieldset.#{as} #{countable}[@value='#{value.to_s}']")
              output_buffer.should have_tag("form fieldset.#{as} #{countable}#post_category_name_#{value.to_s}") if as == :radio
            end
          end
        end
        ...
        if as == :radio
          describe 'and the :collection is an array of arrays with boolean values' do
            ...
            it "should use the first value as the label text and the last value as the value attribute for #{countable}" do
              ...
              output_buffer.should have_tag("form fieldset.#{as} #{countable}#post_category_name_true")
              output_buffer.should have_tag("form fieldset.#{as} #{countable}#post_category_name_false")
            end
          end
        end
        ...
        describe 'and the :collection is an array of symbols' do
          ...
          it "should use the symbol as the label text and value for each #{countable}" do
            ...
            @categories.each do |value|
              label = as == :select ? :option : :label
              output_buffer.should have_tag("form fieldset.#{as} div.controls #{label}", /#{value}/i)
              output_buffer.should have_tag("form fieldset.#{as} #{countable}[@value='#{value.to_s}']")
            end
          end
        end
        ...
        describe 'when the :member_label option is provided' do
          ...
          describe 'as a symbol' do
            ...
            it 'should have options with text content from the specified method' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form fieldset.#{as}", /#{author.login}/)
              end
            end
          end
          ...
          describe 'as a proc' do
            ...
            it 'should have options with the proc applied to each' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form fieldset.#{as}", /#{author.login.reverse}/)
              end
            end
          end
          ...
          Formtastic::FormBuilder.collection_label_methods.each do |label_method|
            ...
            describe "when the collection objects respond to #{label_method}" do
              ...
              it "should render the options with #{label_method} as the label" do
                ::Author.all.each do |author|
                  output_buffer.should have_tag("form fieldset.#{as}", /The Label Text/)
                end
              end
            end
        ...
        describe 'when the :member_value option is provided' do
          ...
          describe 'as a symbol' do
            ...
            it 'should have options with values from specified method' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form fieldset.#{as} #{countable}[@value='#{author.login}']")
              end
            end
          end
          ...
          describe 'as a proc' do
            ...
            it 'should have options with the proc applied to each value' do
              ::Author.all.each do |author|
                output_buffer.should have_tag("form fieldset.#{as} #{countable}[@value='#{author.login.reverse}']")
              end
            end
          end
