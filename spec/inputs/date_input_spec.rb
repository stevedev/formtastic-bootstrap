...
describe 'date input' do
  ...
  describe "general" do
    ...
    it 'should have a legend and label with the label text inside the fieldset' do
      output_buffer.should have_tag('form fieldset.control-group.date label', /Publish at/)
    end
    ...
    it 'should (sort of) associate the label with the input' do
      output_buffer.should have_tag('form fieldset.control-group.date label[@for="post_publish_at"]')
      output_buffer.should have_tag('form fieldset.control-group.date div.controls input[@id="post_publish_at[date]"]')
    end
    ...
    it 'should have an text input inside the div' do
      output_buffer.should have_tag('form fieldset.control-group.date div.controls input[@type="text"]')
    end
