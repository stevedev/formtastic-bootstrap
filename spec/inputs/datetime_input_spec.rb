...
describe 'datetime input' do
  ...
  describe "general" do
    ...
    it 'should have a legend and label with the label text inside the fieldset' do
      output_buffer.should have_tag('form fieldset.control-group.datetime label', /Publish at/)
    end
    ...
    it 'should have two inputs' do
      output_buffer.should have_tag('form fieldset.control-group.datetime div.controls input', :count => 2)
    end
