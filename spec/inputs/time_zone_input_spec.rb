...
describe 'time_zone input' do
  ...
  it 'should generate a label for the input' do
    output_buffer.should have_tag('form fieldset label')
    output_buffer.should have_tag('form fieldset label[@for="post_time_zone"]')
    output_buffer.should have_tag('form fieldset label', /Time zone/)
  end
  ...
  describe "when index is provided" do
    ...
    it 'should index the id of the wrapper' do
      output_buffer.should have_tag("fieldset#post_author_attributes_3_name_input")
    end
  ...
  describe 'when no object is given' do
    ...
    it 'should generate labels' do
      output_buffer.should have_tag('form fieldset label')
      output_buffer.should have_tag('form fieldset label[@for="project_time_zone"]')
      output_buffer.should have_tag('form fieldset label', /Time zone/)
    end
